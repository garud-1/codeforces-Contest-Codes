...
// bit number for 57 is 111001
/*
 bit number for 37 is 100101

 now we have consecative numbers which make an = n xor x and bn = n xor y
    so we have to find the number which is common in both the numbers but in consecative and its maximum length 
    so we have to find the number of bits which are same in both the numbers
